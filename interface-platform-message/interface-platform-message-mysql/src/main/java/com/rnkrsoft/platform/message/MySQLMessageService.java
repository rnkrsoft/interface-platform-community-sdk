package com.rnkrsoft.platform.message;
...
import com.rnkrsoft.platform.message.mysql.dao.InterfaceResponseDao;
import com.rnkrsoft.platform.message.mysql.entity.InterfaceRequestEntity;
import com.rnkrsoft.platform.message.mysql.entity.InterfaceResponseEntity;
...
public class MySQLMessageService extends AsyncMessageQueueMessageService implements MessageService {
    ...
    public MySQLMessageService(InterfaceRequestDao interfaceRequestDao, InterfaceResponseDao interfaceResponseDao) {
        this.interfaceRequestDao = interfaceRequestDao;
        this.interfaceResponseDao = interfaceResponseDao;
    }
