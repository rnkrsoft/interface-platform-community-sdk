...
import com.rnkrsoft.platform.definition.mysql.dao.InterfaceDefinitionDAO;
import com.rnkrsoft.platform.definition.mysql.entity.InterfaceDefinitionEntity;
 ...
 */
@Slf4j
public class MySQLInterfaceDefinitionService implements InterfaceDefinitionService{
    /**
     * 是否使用本地缓存
     */
    @Setter
